...
function hue_func() {
    document.getElementById("hue").className ="action_btn_pressed";
    // document.getElementById("saturation").className ="action_btn";
    document.getElementById("luminance").className ="action_btn";
...
function saturation_func() {
    document.getElementById("hue").className ="action_btn";
    // document.getElementById("saturation").className ="action_btn_pressed";
    document.getElementById("luminance").className ="action_btn";
...
function luminance_func() {
    document.getElementById("hue").className ="action_btn";
    // document.getElementById("saturation").className ="action_btn";
    document.getElementById("luminance").className ="action_btn_pressed";
